...
public class TicTacToe {
	...
	private void winner() {
		if(b1 ==1 && b2 == 1 && b3 == 1) {
			...
			JOptionPane.showConfirmDialog(frame, "Player X Wins", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
			xCount1++;
			xCount.setText(String.valueOf(xCount1));
		}
	...
	private void initialize() {
		...
		btn1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn1.setForeground(Color.BLUE);b1 = 0;i++;}
				choosePlayer();
				winner();
			}
		});
		...
		btn2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn2.setForeground(Color.BLUE);b2 = 0;i++;}
				choosePlayer();
				winner();
			}
		});
		...
		btn3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn3.setForeground(Color.BLUE);b3=0;i++;}
				choosePlayer();
				winner();
			}
		});
		...
		btn4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn4.setForeground(Color.BLUE);b4 = 0;i++;}
				choosePlayer();
				winner();
			}
		});
		...
		btn5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn5.setForeground(Color.BLUE);b5 = 0;i++;}
				choosePlayer();
				winner();
			}
		});
		...
		btn6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn6.setForeground(Color.BLUE);b6 = 0;i++;}
				choosePlayer();
				winner();
			}
		});
		...
		btn7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn7.setForeground(Color.BLUE);
				b7 = 0;
				i++;
				}
		...
		btn8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn8.setForeground(Color.BLUE);b8 = 0;i++;}
				choosePlayer();
				winner();
			}
		});
		...
		btn9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				else {btn9.setForeground(Color.BLUE);b9=0;i++;}
				choosePlayer();
				winner();
			}
		});
		...
		btnExit.setFont(new Font("Dialog", Font.BOLD, 22));
